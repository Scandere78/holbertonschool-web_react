...
function Login() {
  return (
    <div className="App-body p-8" style={{ borderTop: '3px solid var(--main-color)' }}>
      ...
      <div className="flex flex-wrap gap-4 items-center">
        ...
        <button type="button" className="px-4 py-1 bg-white border border-gray-300 rounded cursor-pointer hover:bg-gray-100">OK</button>
      </div>
    </div>
  );
}
