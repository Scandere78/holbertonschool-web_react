...
// New JSON data with unread notifications
const notificationsData = [
  ...
  },
  {
    ...
    context: {
      ...
      isRead: false,
      type: "urgent",
      value: "ut labore et dolore magna aliqua. Dignissim convallis aenean et tortor at risus viverra adipiscing. Ac tortor vitae purus faucibus ornare suspendisse."
    }
  },
  {
  ...
  },
  {
    ...
    author: {
      ...
      name: { first: "Christy", last: "Collier" },
  ...
  },
  {
    ...
    author: {
      ...
      name: { first: "Mason", last: "Douglas" },
      email: "mason.douglas@holberton.nz",
      picture: "http://placehold.it/32x32",
      age: 31
    },
    context: {
      guid: "de55f849-2418-4a48-9353-639fc256f9c8",
      isRead: false,
      type: "default",
      value: "Cursus metus aliquam eleifend mi in. Ultrices neque ornare aenean euismod elementum nisi quis"
    }
  },
  {
  ...
  },
  {
    ...
    context: {
      ...
      isRead: true,
      type: "urgent",
      value: "Est ante in nibh mauris cursus mattis molestie a iaculis. Eget lorem dolor sed viverra ipsum. Dolor sit amet consectetur adipiscing elit."
    }
  },
  {
  ...
  },
  {
    ...
    author: {
      ...
      name: { first: "Valentine", last: "Juarez" },
  ...
  },
  {
    ...
    author: {
      ...
      name: { first: "Maryann", last: "Larson" },
  ...
  },
  {
    ...
    author: {
      ...
      name: { first: "Knowles", last: "Vazquez" },
  ...
  },
  {
    ...
    author: {
      ...
      name: { first: "Greta", last: "Benjamin" },
...
export const fetchNotifications = createAsyncThunk(
  ...
  async () => {
    ...
    return new Promise((resolve) => {
      setTimeout(() => {
        // Filter only unread notifications and map to the required format
        const unreadNotifications = notificationsData
          .filter((item) => !item.context.isRead)
          .map((item) => ({
            id: item.id,
